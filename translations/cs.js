...
window.translations.cs = {
  ...
  form: {
    section1_title:     'Kontaktní údaje',
    section2_title:     'Vaše role',
    section3_title:     'Kontext projektu',
    ...
    email_placeholder:      'jan@firma.cz',
    phone_label:            'Telefon',
    phone_placeholder:      '+420 123 456 789',
    company_label:          'Název firmy',
    company_placeholder:    'Acme s.r.o.',
    website_label:          'Web firmy',
    website_placeholder:    'https://acme.cz',

    role_label:       'Vaše role',
    role_placeholder: 'Vyberte roli…',
    role_opt_ceo:     'Majitel / CEO',
    role_opt_sales:   'Obchodní ředitel',
    role_opt_mktg:    'Marketing manager',
    role_opt_ops:     'Operations',
    role_opt_other:   'Jiné',

    size_label:       'Velikost firmy',
    ...
    project_placeholder: 'Popište výzvu nebo proces, který chcete řešit…',

    timing_label:       'Preferovaný čas schůzky',
    timing_placeholder: 'Vyberte datum a čas',
