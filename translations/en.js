...
window.translations.en = {
  ...
  form: {
    section1_title:     'Contact Info',
    section2_title:     'Your Role',
    ...
    role_opt_ceo:     'Owner / CEO',
    role_opt_sales:   'Sales Director',
    role_opt_mktg:    'Marketing Manager',
    role_opt_ops:     'Operations',
    role_opt_other:   'Other',
    ...
    timing_placeholder: 'Select date & time',
